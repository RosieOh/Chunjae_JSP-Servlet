...
<nav class="gnb">
    <ul>
        <li><a href="test01.jsp">전역변수 테스트</a></li>
        <li><a href="test02error.jsp">에러페이지 테스트1</a></li>
        <li><a href="test03.jsp">includeFile</a></li>
        ...
        <li><a href="test15.jsp">액션태그1 - useBean/foward</a></li>
        <li><a href="test16.jsp">액션태그2 - useBean/param</a></li>
